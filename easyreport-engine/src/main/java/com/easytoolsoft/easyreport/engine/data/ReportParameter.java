...
public class ReportParameter {
	...
	private boolean showDataLinks = false;
	 ...
	 *            报表sql查询语句
	 */
	public ReportParameter(final String id, final String name, final int layout, final int statColumnLayout, final List<ReportMetaDataColumn> metaColumns, final Set<String> enabledStatColumns, final boolean isRowSpan,
	...
	public boolean shouldShowDataLinks() {
		return isRestMode && showDataLinks;
	}

	public void setRestMode(boolean isRestMode) {
		this.isRestMode = isRestMode;
	}

	public void setShowDataLinks(boolean showDataLinks) {
		this.showDataLinks = showDataLinks;
	}
}
